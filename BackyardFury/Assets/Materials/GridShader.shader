...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:False,rfrpn:Refraction,coma:15,ufog:True,aust:False,igpj:True,qofs:-10,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:4013,x:32719,y:32712,varname:node_4013,prsc:2|emission-3097-OUT,alpha-150-OUT;n:type:ShaderForge.SFN_Color,id:1304,x:31131,y:32690,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_1304,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0,c3:0,c4:0.447;n:type:ShaderForge.SFN_Code,id:150,x:32077,y:33098,varname:node_150,prsc:2,code:,output:0,fname:Function_node_150,width:465,height:148,input:2,input:0,input:0,input:0,input:2,input_1_label:pos,input_2_label:space,input_3_label:alpha,input_4_label:width,input_5_label:offs|A-5269-XYZ,B-4064-OUT,C-7822-OUT,D-7350-OUT,E-9055-XYZ;n:type:ShaderForge.SFN_FragmentPosition,id:5269,x:31760,y:33111,varname:node_5269,prsc:2;n:type:ShaderForge.SFN_ValueProperty,id:4064,x:31760,y:33281,ptovrint:False,ptlb:GridSpacing,ptin:_GridSpacing,varname:node_4064,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:1;n:type:ShaderForge.SFN_Color,id:2578,x:32291,y:32584,ptovrint:False,ptlb:HighlightColor,ptin:_HighlightColor,varname:node_2578,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0,c2:1,c3:0.1310346,c4:1;n:type:ShaderForge.SFN_Vector4Property,id:254,x:31131,y:32866,ptovrint:False,ptlb:HighlightPos,ptin:_HighlightPos,varname:node_254,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0,v2:0,v3:0,v4:0;n:type:ShaderForge.SFN_Code,id:2855,x:31682,y:32860,varname:node_2855,prsc:2,code:ZgBsAG8AYQB0ADMAIABkAGkAZgAgAD0AIABoAGkALQB3AG8AOwAKAHIAZQB0AHUAcgBuACAAcABvAHcAKABzAHEAcgB0ACgAKABkAGkAZgAuAHgAKgBkAGkAZgAuAHgAKQArACgAZABpAGYALgB6ACoAZABpAGYALgB6ACkAKQAvACgAZABzAHQALwAyAC4AMAApACwAZQBkAGcAZQApADsA,output:0,fname:Function_node_2855,width:527,height:194,input:2,input:2,input:0,input:0,input_1_label:hi,input_2_label:wo,input_3_label:dst,input_4_label:edge|A-254-XYZ,B-5253-XYZ,C-2614-OUT,D-102-OUT;n:type:ShaderForge.SFN_Lerp,id:3097,x:32497,y:32734,varname:node_3097,prsc:2|A-2578-RGB,B-1304-RGB,T-1611-OUT;n:type:ShaderForge.SFN_ValueProperty,id:314,x:31136,y:33344,ptovrint:False,ptlb:HighlightDist,ptin:_HighlightDist,varname:node_314,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:1.4;n:type:ShaderForge.SFN_FragmentPosition,id:5253,x:31131,y:33030,varname:node_5253,prsc:2;n:type:ShaderForge.SFN_ValueProperty,id:102,x:31136,y:33424,ptovrint:False,ptlb:HighlightEdge,ptin:_HighlightEdge,varname:node_102,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:30;n:type:ShaderForge.SFN_ValueProperty,id:7350,x:31760,y:33375,ptovrint:False,ptlb:LineWidth,ptin:_LineWidth,varname:node_7350,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0.1;n:type:ShaderForge.SFN_Clamp01,id:1611,x:32291,y:32826,varname:node_1611,prsc:2|IN-2855-OUT;n:type:ShaderForge.SFN_Vector4Property,id:9055,x:31760,y:33454,ptovrint:False,ptlb:GridOffset,ptin:_GridOffset,varname:node_9055,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0.5,v2:0,v3:0.5,v4:0;n:type:ShaderForge.SFN_Lerp,id:7822,x:32497,y:32910,varname:node_7822,prsc:2|A-2578-A,B-1304-A,T-1611-OUT;n:type:ShaderForge.SFN_ValueProperty,id:777,x:30898,y:33456,ptovrint:False,ptlb:PulseAmount,ptin:_PulseAmount,varname:node_777,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:1;n:type:ShaderForge.SFN_Sin,id:8533,x:30862,y:33069,varname:node_8533,prsc:2|IN-829-OUT;n:type:ShaderForge.SFN_RemapRangeAdvanced,id:8463,x:31081,y:33197,varname:node_8463,prsc:2|IN-8533-OUT,IMIN-1545-OUT,IMAX-9396-OUT,OMIN-7901-OUT,OMAX-777-OUT;n:type:ShaderForge.SFN_Vector1,id:1545,x:30862,y:33231,varname:node_1545,prsc:2,v1:-1;n:type:ShaderForge.SFN_Vector1,id:9396,x:30862,y:33300,varname:node_9396,prsc:2,v1:1;n:type:ShaderForge.SFN_Vector1,id:7901,x:30862,y:33361,varname:node_7901,prsc:2,v1:0;n:type:ShaderForge.SFN_Time,id:221,x:30465,y:33088,varname:node_221,prsc:2;n:type:ShaderForge.SFN_ValueProperty,id:4671,x:30465,y:32983,ptovrint:False,ptlb:PulseSpeed,ptin:_PulseSpeed,varname:node_4671,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:1;n:type:ShaderForge.SFN_Multiply,id:829,x:30652,y:33069,varname:node_829,prsc:2|A-4671-OUT,B-221-T;n:type:ShaderForge.SFN_Add,id:2614,x:31286,y:33208,varname:node_2614,prsc:2|A-8463-OUT,B-314-OUT;proporder:1304-4064-254-2578-314-102-7350-9055-777-4671;pass:END;sub:END;*/
...
Shader "Shader Forge/GridShader" {
    Properties {
        ...
        _PulseAmount ("PulseAmount", Float ) = 1
...
////// Emissive:
                ...
                float node_1545 = (-1.0);
                float node_7901 = 0.0;
                float node_1611 = saturate(Function_node_2855( _HighlightPos.rgb , i.posWorld.rgb , ((node_7901 + ( (sin((_PulseSpeed*node_221.g)) - node_1545) * (_PulseAmount - node_7901) ) / (1.0 - node_1545))+_HighlightDist) , _HighlightEdge ));
